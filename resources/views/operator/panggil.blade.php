...
<div class="w-full p-8 flex justify-center space-x-10 h-screen items-center">
  ...
  <div class="flex flex-col space-y-8">
    ...
    <div class="flex justify-between">
      <a href="/operator/antrian/jenjang/{{ $antrian->jenjang }}/belum" class="border-2 border-black bg-blue-600 text-white w-max rounded-full hover:underline py-2 px-4 font-semibold">Kembali Ke Menu Tadi</a>
    ...
    <form action="/operator/antrian/lanjut/bendahara" method="post">
      ...
      <button type="submit" id="lanjut-bendahara-btn" class="disabled:text-black/60 bg-green-600 text-white font-bold py-2 px-6 rounded-full border-2 border-black">Lanjut Ke Bendahara</button>
    </form>
