...
@section('content')
<header class="flex space-y-2 p-6 flex-col w-full fixed items-center">
  <img src="wk.png" class="w-16 md:w-20" alt="logo-wk">
  <h1 class="text-2xl md:text-3xl  font-semibold uppercase text-[#1a5088] -translate-y-1">Antrean SWK</h1>
</header>
