...
<div class="w-full p-8 flex justify-center space-x-10 h-screen items-center">
  ...
  <a href="/bendahara/antrian/belum" class="bg-blue-600 text-white w-max rounded-full hover:underline py-2 px-4 font-semibold">Kembali Ke Menu Tadi</a>
  ...
  <div class="flex space-x-4">
    <form action="/bendahara/antrian/lanjut/" class="block" method="post">
      @csrf
      <input type="hidden" name="antrian_id" value="{{$antrian->id }}" />
    ...
    <form action="/bendahara/antrian/lewati/" class="block" method="post">
      @csrf
      <input type="hidden" name="antrian_id" value="{{$antrian->id }}" />
    ...
    <form action="/bendahara/antrian/terpanggil" class="block" method="post">
      @method('PUT')
      @csrf
      <input type="hidden" name="antrian_id" value="{{ $antrian->id }}" />
      <input type="hidden" name="antrian_jenjang" value="{{ $antrian->jenjang }}" />
