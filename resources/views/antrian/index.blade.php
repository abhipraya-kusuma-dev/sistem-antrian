            ...
            <div class="flex col-span-12">
                <div class="flex flex-col w-full text-center space-y-2 text-white">
                    <div id="current-antrian-title" class="bg-blue-400 w-full p-2 rounded-md">
                        <h1 class="text-5xl font-semibold text-stroke-2 text-stroke-black uppercase">Antrean</h1>
                    </div>
                    <div id="current-antrian-nomor" class="bg-blue-400 p-6 py-9 rounded-md">
                        <p id="nomor_antrian"
                            class="text-9xl font-bold drop-shadow-xl shadow-black text-stroke-4 text-stroke-black">0000</p>
                    </div>
                    <div id="current-antrian-loket" class="bg-blue-400 p-2 rounded-md">
                        <p id="loket_antrian" class="text-5xl uppercase font-semibold text-stroke-2 text-stroke-black">Loket
                        </p>
                        <p id="antrian_jenjang"
                            class="text-5xl uppercase font-semibold text-stroke-2 text-stroke-black hidden">()</p>
                    </div>
                </div>
            </div>
    ...
    <footer class="flex justify-between p-4 fixed inset-x-0 bottom-0 items-center">
        ...
        <div class="flex items-center space-x-8 ">
            ...
            <div class="flex space-x-4 items-center">
                ...
                <span class="font-semibold">sekolahwijayakusuma.sch.id</span>
            </div>
            <div class="flex space-x-4 items-center">
