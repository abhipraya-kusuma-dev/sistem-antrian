...
<main class="p-6">
    ...
    <div class="flex col-span-7">
      <div class="flex flex-col w-full text-center space-y-2 text-white">
        <div id="current-antrian-title" class="bg-blue-400 w-full p-2 rounded-md">
          <h1 class="text-5xl font-semibold text-stroke-2 text-stroke-white">Antrean</h1>
        </div>
        <div id="current-antrian-nomor" class="bg-blue-400 p-6 py-9 rounded-md">
          <p id="nomor_antrian" class="text-9xl font-bold drop-shadow-xl shadow-black text-stroke-4 text-stroke-white">0000</p>
        </div>
        <div id="current-antrian-loket" class="bg-blue-400 p-2 rounded-md">
          <p id="loket_antrian" class="text-5xl uppercase font-semibold text-stroke-2 text-stroke-white">Loket</p>
          <p id="antrian_jenjang" class="text-5xl uppercase font-semibold text-stroke-2 text-stroke-white hidden">()</p>
        </div>
      </div>
    </div>
  ...
  <div id="card-container" class="grid grid-cols-5 gap-4 mt-8">
    ...
    <div style="background-color: {{ $warna[$loop->index] }};" class=" rounded-md text-center  space-y-8 py-4 text-white">
      <p class="-translate-y-2 text-3xl font-semibold uppercase text-stroke text-stroke-white flex flex-col"><span>Loket</span>{{ $antrianKey }}</p>
      <hr class="-translate-y-8">
      <p class="text-5xl font-bold text-stroke text-stroke-white -translate-y-8">{{ count($antrian[$antrianKey]) ? $antrian[$antrianKey][0]->nomor_antrian : 'Kosong' }}</p>
    </div>
    @endforeach
  </div>
...
<footer class="flex justify-between p-4 fixed inset-x-0 bottom-0 items-center">
  ...
  <div class="flex items-center space-x-4 ">
    <div class="flex space-x-4 items-center">
      ...
      <span class="font-semibold">sekolah_wijayakusma</span>
    </div>
    <div class="flex space-x-4 items-center">
      <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 48 48" width="1em" height="1em" fill-rule="evenodd" clip-rule="evenodd">
