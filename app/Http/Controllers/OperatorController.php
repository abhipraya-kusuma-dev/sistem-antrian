...
class OperatorController extends Controller
{
  ...
  public function lanjutKeBendahara(Request $request)
  {
    ...
    return redirect('/operator/antrian/jenjang/' . $data['antrian_jenjang'] . '/belum')->with('create-success', 'Antrian dilanjut ke bendahara dengan nomor antrian ' . AntrianHelper::generateNomorAntrian($isAntrianCreated->kode_antrian, $isAntrianCreated->nomor_antrian));
  }
}
